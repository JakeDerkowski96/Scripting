# PowerShell module: KQL Parser 
# Source: https://github.com/mdowst/KQLParser/blob/master/Examples/LogAnalytics-Query-and-Parse.ps1
# This example can most likely be leveraged to automate report creation
